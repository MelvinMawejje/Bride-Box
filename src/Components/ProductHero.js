    ...
    <section>
      <div className="px-4 mx-auto max-w-screen-xl">
          ...
          <p className="mb-8 mt-12 text-[30px] lg:text-[40px] text-[#686868] font-normal md:text-left">HerBrideBoxUg is your destination for All kinds of bridal accessories to prepare you for your big day!</p>
            ...
            <a href="https://www.instagram.com/her_bride_box_ug/" target='_blank'>
              <Button variant='contained'sx={{marginBottom:{xs:"20px"},padding:"15px",backgroundColor:"#73A336", ":hover":{backgroundColor:"darkgreen"}}}>
                <svg className="w-7 h-auto" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            </svg> &nbsp; Visit Our Instagram</Button></a>
